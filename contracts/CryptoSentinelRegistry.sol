...
/// @title CryptoSentinel On-Chain Registry
/// @notice Stores attestations and signal hashes produced by the CryptoSentinel engine.
/// @dev Authorised reporters publish scored signals that downstream contracts can consume.
contract CryptoSentinelRegistry {
